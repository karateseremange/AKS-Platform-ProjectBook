...
Le chantier suivant est **AKS Inscriptions**. Son cadrage fonctionnel, son modèle métier, ses services, la reprise des trois Google Forms, les interfaces de contrôle, le socle transverse d’accès privés et les contrats techniques sont validés dans [`INSCRIPTIONS-001`](project-book/modules/inscriptions/INSCRIPTIONS-001.md) à [`INSCRIPTIONS-005`](project-book/modules/inscriptions/INSCRIPTIONS-005.md). Les jeux d’essai et la stratégie de recette cumulative sont en revue dans [`INSCRIPTIONS-006`](project-book/modules/inscriptions/INSCRIPTIONS-006.md), sans code applicatif à ce stade.
