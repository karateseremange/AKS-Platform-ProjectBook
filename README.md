...
Le troisième incrément est cadré dans [`INSCRIPTIONS-009`](project-book/modules/inscriptions/INSCRIPTIONS-009.md), actuellement en revue. Il propose un journal de commandes injectable, des transitions fermées, l’idempotence et la reprise après reconstruction du service, toujours sans API Google, donnée métier réelle, interface ni déploiement. Son éventuelle validation autorisera une implémentation applicative distincte ; aucun nouveau total de tests n’est annoncé avant preuve.
