...
Le chantier suivant est **AKS Inscriptions**. Son cadrage fonctionnel, son modèle métier, ses services et la reprise des trois Google Forms sont validés dans [`INSCRIPTIONS-001`](project-book/modules/inscriptions/INSCRIPTIONS-001.md), [`INSCRIPTIONS-002`](project-book/modules/inscriptions/INSCRIPTIONS-002.md) et [`INSCRIPTIONS-003`](project-book/modules/inscriptions/INSCRIPTIONS-003.md). Les interfaces de contrôle et le socle transverse d’accès privés pour Inscriptions, Analytics et Présences sont en revue dans [`INSCRIPTIONS-004`](project-book/modules/inscriptions/INSCRIPTIONS-004.md), sans code applicatif à ce stade.
