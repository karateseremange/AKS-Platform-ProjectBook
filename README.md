...
Le chantier suivant est **AKS Inscriptions**. Son cadrage fonctionnel, son modèle métier, ses services, la reprise des trois Google Forms, les interfaces de contrôle et le socle transverse d’accès privés sont validés dans [`INSCRIPTIONS-001`](project-book/modules/inscriptions/INSCRIPTIONS-001.md) à [`INSCRIPTIONS-004`](project-book/modules/inscriptions/INSCRIPTIONS-004.md). Les contrats techniques de stockage, d’identifiants, d’idempotence, d’audit et d’intégration sont en revue dans [`INSCRIPTIONS-005`](project-book/modules/inscriptions/INSCRIPTIONS-005.md), sans code applicatif à ce stade.
