...
| ADMIN-006 | Administration multi-compte et accès aux supports privés | Lot A implémenté en PR — validation et fusion attendues | 0.4.0 | ACCESS-002, CONFIG-001, LOG-001, AUDIT-001-PRODUCTION, SECURITY-001 |
...
| ADMIN-006-02 | Contrat du prototype LOG_READ avec backend privé signé | Cadrage détaillé terminé — implémentation non autorisée | 0.1.0 | ADMIN-006, ADMIN-006-01, ACCESS-002, LOG-001, AUDIT-001 |
| ADMIN-006-03 | Implémentation des contrats purs AKS-PRIVATE/1 | Implémenté en PR — fusion et validation Apps Script attendues | 0.1.0 | ADMIN-006, ADMIN-006-01, ADMIN-006-02, AKS-Platform #140 |
