...
| ROADMAP-001 | Feuille de route officielle | Stratégie | Validé | 1.2.87 | Définit l'ordre et les priorités d'évolution |
...
| ACCESS-002 | Administration des utilisateurs et habilitations privées | Réalisation engagée — ACCESS-002-01 clôturé ; ACCESS-002-02 proposé | 0.4.0 | ACCESS-001, ADMIN-001 à ADMIN-005, SECURITY-001, CONFIG-001, AUDIT-001 |
...
| ACCESS-002-02 | Amorçage contrôlé et migration du premier gestionnaire ACCESS | Proposé — cadrage à valider avant implémentation ou amorçage réel | 0.1.0 | ACCESS-002, ACCESS-002-01, ACCESS-001, SECURITY-001, AUDIT-001, CONFIG-001 |
...
| Administration | ADMIN-001 à ADMIN-005, ACCESS-002, ACCESS-002-01, ACCESS-002-02, CONFIG-001, LOG-001, AUDIT-001, AUDIT-001-RECETTE | Socle validé — ACCESS-002 0.4.0 en réalisation ; ACCESS-002-01 1.0.0 clôturé dans `develop` au commit `91ba7e3`, campagne cumulative réelle 477/477 réussie sans échec ; ACCESS-002-02 0.1.0 proposé sans amorçage réel |
