...
| ROADMAP-001 | Feuille de route officielle | Stratégie | Validé | 1.2.68 | Définit l'ordre et les priorités d'évolution |
...
| AKS Inscriptions | `project-book/modules/inscriptions/` | `INSCRIPTIONS-001` à `INSCRIPTIONS-006`, `INSCRIPTIONS-008` | Premier socle validé par 341/341 tests ; deuxième incrément accès et audit en revue |
...
| INSCRIPTIONS-008 | Deuxième incrément : accès et audit sans écriture métier | En revue | 1.0.0 | INSCRIPTIONS-004 à INSCRIPTIONS-006, ACCESS-001, AUDIT-001, SECURITY-001, ERROR-001 |
...
|---------|------|-----------|
| 1.2.76 | 2026-08-02 | Ouverture d’INSCRIPTIONS-008 : deuxième incrément borné aux capacités Inscriptions d’ACCESS-001, aux périmètres explicites et à l’audit obligatoire sans écriture métier |
