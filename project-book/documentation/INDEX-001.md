...
| ROADMAP-001 | Feuille de route officielle | Stratégie | Validé | 1.2.50 | Définit l'ordre et les priorités d'évolution |
...
| Présences | Extension d’AKS Analytics | `ANALYTICS-SAISIE-001` à `ANALYTICS-SAISIE-006` | Recette mobile isolée validée sur `develop` ; déploiement de recette autorisé |
...
| ANALYTICS-SAISIE-006 | Recette fonctionnelle mobile isolée | Validée sur `develop` — déploiement Web de recette autorisé | 1.0.1 | ANALYTICS-SAISIE-001 à ANALYTICS-SAISIE-005, ACCESS-001, UX-001, API-001 |
