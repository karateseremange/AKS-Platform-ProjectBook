...
| ROADMAP-001 | Feuille de route officielle | Stratégie | Validé | 1.2.36 | Définit l'ordre et les priorités d'évolution |
...
| ACCESS-001 | Rôles, capacités et affectations Analytics | Socle implémenté sur `develop` — validation Apps Script requise | 1.0.2 | ANALYTICS-SAISIE-001, SECURITY-001, CONFIG-001, LOG-001, AUDIT-001, API-001 |
