...
| ACCESS-002 | Administration des utilisateurs et habilitations privées | Réalisation engagée — ACCESS-002-03 lot 1 en revue | 0.4.14 | ACCESS-001, ADMIN-001 à ADMIN-005, SECURITY-001, CONFIG-001, AUDIT-001 |
...
| ACCESS-002-03 | Liste, recherche et cycle de vie des comptes d’accès | Réalisation engagée — lot 1 en revue | 0.3.0 | ACCESS-002, ACCESS-002-01, ACCESS-002-02, ACCESS-001, SECURITY-001, AUDIT-001, AKS-Platform #101 |
...
|---------|------|-----------|
| 1.3.10 | 2026-08-13 | ACCESS-002-03 0.3.0 engagé par la PR applicative brouillon #101 : projection serveur en lecture seule, tests ciblés 10/10, syntaxe 198/198 et inventaire cumulatif préparé à 517 références uniques ; ACCESS-002 0.4.14 et ROADMAP-001 1.3.1 alignées, sans recette Apps Script ni donnée réelle |
