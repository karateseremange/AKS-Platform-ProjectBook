...
| ROADMAP-001 | Feuille de route officielle | Stratégie | Validé | 1.2.64 | Définit l'ordre et les priorités d'évolution |
...
| AKS Inscriptions | `project-book/modules/inscriptions/` | `INSCRIPTIONS-001` à `INSCRIPTIONS-005` | Cadrage, modèle métier, services, reprise Google Forms, interfaces et accès privés validés ; contrats techniques en revue — aucun code applicatif |
...
| AKS Inscriptions | INSCRIPTIONS-001 à INSCRIPTIONS-005 | Cadrage, modèle métier, services, reprise Google Forms, interfaces et accès privés validés ; contrats techniques en revue ; aucun code applicatif |
