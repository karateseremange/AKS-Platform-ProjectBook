...
| ROADMAP-001 | Feuille de route officielle | Stratégie | Validé | 1.2.79 | Définit l'ordre et les priorités d'évolution |
...
| ACCESS-002 | Administration des utilisateurs et habilitations privées | Brouillon de cadrage | 0.1.0 | ACCESS-001, ADMIN-001 à ADMIN-005, SECURITY-001, CONFIG-001, AUDIT-001 |
...
| Administration | ADMIN-001 à ADMIN-005, ACCESS-002, CONFIG-001, LOG-001, AUDIT-001, AUDIT-001-RECETTE | Socle validé — ACCESS-002 en cadrage pour administrer le moteur ACCESS-001 et achever le raccordement transverse |
