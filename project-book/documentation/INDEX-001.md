...
| ADMIN-006 | Administration multi-compte et accès aux supports privés | D4-C — précontrôle lecture seule corrigé, contrôle Windows requis | 0.51.0 | ACCESS-002, CONFIG-001, LOG-001, AUDIT-001-PRODUCTION, SECURITY-001 |
...
| ADMIN-006-08 | Raccordement privé RECETTE et recette multi-compte LOG_READ | D4-C — précontrôle lecture seule corrigé, contrôle Windows requis | 0.36.0 | ADMIN-006, ADMIN-006-02, ADMIN-006-06, ADMIN-006-14, ACCESS-002, LOG-001 |
