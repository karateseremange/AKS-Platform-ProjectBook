...
| **Version** | 0.4.56 |
| **Statut** | V1.4.0 en production — V1.4.1 publiée et taguée dans Git, non déployée |
| **Nature** | Spécification fonctionnelle et de sécurité |
| **Propriétaire** | Product Owner |
| **Dernière mise à jour** | 2026-08-27 |
| **Version du produit** | V1.4.0 en production — V1.4.1 publiée dans Git |
...
|---|---|---|
| 0.4.56 | 2026-08-27 | Tags légers `v1.4.1` créés et vérifiés : application `7e5125e7`, Project Book `5f9f6623` ; production inchangée, INSCRIPTIONS-011 non engagé |
| 0.4.55 | 2026-08-27 | PR Project Book de publication #197 fusionnée dans `main` au commit `5f9f6623` ; V1.4.1 publiée dans les deux dépôts, tags et production inchangés, INSCRIPTIONS-011 non engagé |
