...
| **Version** | 0.4.0 |
| **Statut** | Lot 3 implémenté — PR applicative #107 en validation |
...
3. **commande atomique — implémenté dans la PR #107** — remplacement ciblé sous révision et verrou, commentaire et `requestId` bornés, audit persistant, confirmations sensibles, double soumission bornée et restauration exacte ;
