...
1. **projection personnelle et navigation autorisée — en revue** — PR applicative brouillon #112 : instantané effectif personnel, catalogue fermé, cloisonnement des modules, état neutre et destinations historiques transitoires ; 8/8 tests ciblés, suite préparée à 594 ;
2. **Mes accès** — route et vue personnelle minimisée en lecture seule ;
