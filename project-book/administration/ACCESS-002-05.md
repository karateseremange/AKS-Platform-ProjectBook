...
1. **projection personnelle et navigation autorisée** — calcul serveur des habilitations effectives et destinations ;
...
|---|---|---|
| 0.1.0 | 2026-08-13 | Cadrage validé : portail personnalisé selon habilitations effectives, Mes accès personnel et minimisé, état neutre sans habilitation, sécurité serveur, compatibilité URL et transition bornée vers ACCESS-002-06 |
