...
| **Version** | 0.8.0 |
| **Statut** | Lot B validé en RECETTE — fusion applicative attendue |
...
La PR applicative #141 ajoute le backend inactif, les adaptateurs injectables et le registre anti-rejeu sans endpoint, secret ou raccordement Google. Les 18 tests dédiés réussissent localement. La suite cumulative réelle réussit à **701/701** dans Apps Script RECETTE ; la candidate a été relue à 267 fichiers puis RECETTE restaurée exactement à 261 fichiers.

La fusion applicative reste attendue et aucun raccordement réel n’est autorisé.
