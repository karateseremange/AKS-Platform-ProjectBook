...
| LOG-001 | Journalisation — socle structuré et persistance durable dans `AKS_Logs` validés (95/95 tests) ; conservation, purge et consultation administrative restant à réaliser | Validé |
