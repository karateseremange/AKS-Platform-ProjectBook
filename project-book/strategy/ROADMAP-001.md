...
Aucun déploiement utilisateur n’est réalisé à ce stade. La recette fonctionnelle de l’exposition serveur, puis l’interface mobile constituent la suite du chantier.
