...
Aucun déploiement utilisateur n’est réalisé à ce stade. La validation Apps Script de l’exposition serveur, sa recette fonctionnelle, puis l’interface mobile constituent la suite du chantier.
